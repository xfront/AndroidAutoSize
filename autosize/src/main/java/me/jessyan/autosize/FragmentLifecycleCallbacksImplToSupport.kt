...
/**
 * ================================================
 * [FragmentLifecycleCallbacksImplToSupport] 可用来代替在 BaseFragment 中加入适配代码的传统方式
 * [FragmentLifecycleCallbacksImplToSupport] 这种方案类似于 AOP, 面向接口, 侵入性低, 方便统一管理, 扩展性强, 并且也支持适配三方库的 [Fragment]
 *
 *
 ...
 * ================================================
 */
class FragmentLifecycleCallbacksImplToSupport(
    /**
     * 屏幕适配逻辑策略类
     */
